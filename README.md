...
> **Last Updated:** August 17, 2026 at 12:05 PM AKDT (Hourly Sync)


**Public JSON feeds for the University of Alaska Anchorage CACHE continuing education catalog.**

This repository is a public-facing data mirror for CACHE course and event listings. It is auto-generated from the CACHE data pipeline and is intended to be easy to browse, easy to download, and safe to reference from public websites, dashboards, search tools, and SEO workflows.
...
*Maintained by [UAA IPCE](https://github.com/UAA-IPCE) · Auto-updated by CACHE Data Pipeline*
