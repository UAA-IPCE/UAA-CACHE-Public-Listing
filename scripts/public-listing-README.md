...
<!-- LAST_UPDATED -->
> 🕐 **Last synced:** {{GENERATED_DATE}} at {{GENERATED_TIME}} UTC
<!-- /LAST_UPDATED -->
...
<!-- ACTIVE_COURSES_TABLE -->

## Active Courses ({{ACTIVE_COUNT}})
...
- a [training sitemap](training-sitemap.xml) listing all course registration URLs for crawler discovery
- [JSON-LD structured data](https://schema.org/Course) for rich search result eligibility
...
- no app source code
- only clean public documentation, public JSON outputs, and SEO support files
